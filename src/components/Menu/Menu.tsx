		...
		<div className='flex min-h-screen relative'>
			<div className='w-full flex flex-col z-10 p-7 lg:p-14'>
				<div className='flex justify-between'>
					...
					<span className='text-2xl text-secondary '>
						{languages.map((language) => (
							<Link key={language} className='mr-4 cursor-pointer hover:text-principal uppercase' href={`/${language}`}>
								[ {language} ]
							</Link>
						))}
					</span>
				...
				<div className='flex flex-col justify-center items-center h-full'>
					...
					<h2 className='text-xl text-principal w-2/6 text-center'>{t("i_am")}</h2>

					<div className='text-xl my-6 text-principal text-center w-2/6 flex justify-center'>
